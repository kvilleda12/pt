...
Revision ID: 7b1d952d87fa
Revises: 713b1154b689
Create Date: 2025-07-16 12:38:22.933955
...
revision: str = '7b1d952d87fa'
down_revision: Union[str, None] = '713b1154b689'
...
def downgrade() -> None:
    ...
    op.create_table('textbook_sources',
    sa.Column('textbook_id', sa.INTEGER(), autoincrement=True, nullable=False),
